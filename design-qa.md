...
- Second page: `products.html` product listing page with `tu/products/hero-folding-table.jpg` hero banner, 12 product cards from `tu/products`, category filters, inquiry strip, and reused footer/navigation styling.
